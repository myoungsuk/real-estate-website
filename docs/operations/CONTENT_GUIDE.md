...
- 현재 초기 데이터는 공식 네이버 블로그의 2026년 게시글 45건과 공식 유튜브 채널의 실제 영상 40건입니다. 새 글·영상은 관리자 화면에서 추가하면 게시일 기준 위치에 표시됩니다.
...
- 홈은 최근 순서의 8건을 미리 보여주고 `/properties/`는 전체 카드를 표시합니다. 각 카드는 `https://fin.land.naver.com/articles/<매물번호>`로 바로 이동합니다.
