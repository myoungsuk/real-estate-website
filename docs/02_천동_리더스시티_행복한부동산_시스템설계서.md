...
| 작성 기준일 | 2026-08-27 |
| 문서 상태 | 기준 사이트 핵심 공개 흐름·관리자 편집·GitHub 저장 API·예약 동기화·Production 검증 구현 반영 |
...
- Production 산출물의 robots, sitemap, canonical, JSON-LD, 관리자 `noindex`, `deployment-marker.json` 검사
