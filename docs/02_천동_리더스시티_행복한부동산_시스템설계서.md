...
| 버전 | v0.8 Search Discovery |
| 작성 기준일 | 2026-08-28 |
| 문서 상태 | 기준 사이트 핵심 공개 흐름·관리자 편집·예약 동기화·검색도구 등록·검색 변경 알림 구현 반영 |
...
- 홈·매물·단지 목록의 모바일 Lighthouse 성능·접근성·SEO 90점, LCP 2.5초·TBT 200ms·CLS 0.1 기준 검사
...
핵심 Playwright E2E와 Lighthouse는 CI에 포함한다. 실제 Android Chrome·iPhone Safari, 200% 확대, 전화·문자·카카오 앱 전환과 현장 네트워크의 INP는 출시 전 수동 검증으로 남긴다.
