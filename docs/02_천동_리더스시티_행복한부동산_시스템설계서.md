...
| 작성 기준일 | 2026-09-01 |
| 문서 상태 | 신흥 SK뷰 확장 데이터 계약·정규화 매칭·관리자 파서·공개 상태와 로컬 회귀·확대·키보드 검증 완료, 실기기 검수 제외 승인, Production 배포 대기 |
...
- [ ] 로컬·pull request CI 승인 → GitHub `master` → Cloudflare Production 자동 배포 확인
