...
- 홈은 50건 전체를 사진 없는 카드로 6건씩 페이지 처리하고, 홈과 매물 목록에서 가격순·최신순·면적순 정렬을 제공한다. 매물 목록은 거래유형·매물유형 필터도 함께 제공하며, 카드는 같은 매물번호의 `fin.land.naver.com/articles/` 상세 주소를 새 탭으로 연다.
